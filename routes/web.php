...
Route::post('/', 'PurchaseOrderController@purchaseOrder')->name('purchase_order');
...
Route::post('/purchaseorder/{client_id}/{tile}/{piece}', 'PurchaseOrderController@purchaseOrder');
